...
/////////////////////////
  ...
  jQuery('form.ajax-mykomplekt-submit-form input.ajax-cart-submit-form-button').not('.ajax-cart-processed').each(function () {
    var $elem = jQuery(this);
    ...
    if (_checkAjaxify($elem)) {
      ...
      $elem.click(function () {
        var form = jQuery(this).parents('form').eq(0);
        //console.log(Drupal.settings.uc_ajax_cart.CALLBACK);
		form.ajaxSubmit({
          url : '/ajax/mykomplekt/add_komplekt',
          beforeSubmit : function () {
            ajaxCartBlockUI(Drupal.settings.uc_ajax_cart.ADD_TITLE,
                            '<div class="messages status">' + Drupal.settings.uc_ajax_cart.ADD_MESSAGE + '</div>')},
          success : ajaxCartFormSubmitted,
...
function ajaxCartInitCartView() {
  ...
  ////////////////////////////////////////
  ///////////////////////////////////////
  Drupal.attachBehaviors('#view-komplect-block_1');
    ////////////////////////////////////////
  ///////////////////////////////////////
...
function ajaxCartUpdateBlockCart() {
	console.log(Drupal.uc_ajax_cart.update_container);
